...
def check_layout
  ...
  def index
    ...
    @routes = Route.where(status: nil, facility_id: @userfacilities_check).filterrific_find(@filterrific).includes(:zone, :wall, :user, :grade, :facility, :ticks).page(params[:page]).per(50)
