class TicksController < ApplicationController
  ...
  def create
    ...
    if params[:route_id]
      ...
      @route = Route.new(facility_id: @tick.facility_id, zone_id: @zone.id, setdate: @tick.date, grade_id: @tick.grade_id, color_hex: @tick.color_hex, user_id: current_user.id, image: @tick.image, name: @tick.name, description: @tick.description)
      @route.save
