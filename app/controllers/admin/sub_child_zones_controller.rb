class Admin::SubChildZonesController < ApplicationController
  before_action :authenticate_user!,        only: [:new, :create, :edit, :update, :destroy], :unless => :facility_is_demo
  before_action :facility_admin,            only: [:new, :create, :edit, :update, :destroy], :unless => :facility_is_demo
